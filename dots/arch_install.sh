...
pacstrap /mnt base base-devel linux linux-firmware linux-headers nano neovim bash-completion grub efibootmgr networkmanager ttf-opensans ttf-hack ttf-dejavu ttf-ubuntu-font-family ttf-font-awesome ttf-nerd-fonts-symbols ttf-jetbrains-mono-nerd man-db man-pages fish nvidia wayland hyprland hyprpaper xdg-desktop-portal-hyprland waybar pipewire pipewire-pulse wireplumber wl-clipboard grim slurp git kitty btop celluloid imv yazi sof-firmware wiremix telegram-desktop fastfetch hyprpolkitagent os-prober ripgrep openssh firefox npm
