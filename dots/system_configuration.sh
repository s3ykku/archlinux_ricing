...
cp -r ${PATHFROM}/config/mpv ${PATHTO}/.config

cp -r ${PATHFROM}/scripts ${PATHTO}/

mkdir ${PATHTO}/pictures
...
chmod +x ${PATHTO}/downloads/archlinux_ricing/dots/system_configuration.sh

chmod +x ${PATHTO}/downloads/archlinux_ricing/dots/config_updating.sh
...
yay -S visual-studio-code-bin rofi-wayland
